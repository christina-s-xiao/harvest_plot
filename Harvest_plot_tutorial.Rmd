...
This study aimed to compare the effectiveness of carrot, stick, and combined carrot-and-stick interventions in changing different transport behaviors. We will use the same data to design a harvest plot for the driving and public transport outcomes.
