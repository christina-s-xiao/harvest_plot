...
- **quality**: Factor: Indicates the study quality. We have three categories here: low, moderate, and high. This will be represented by the height of the bars<br>
...
```{r}
data_harvest<-readRDS(file = "harvest_plot_data.rds") # Read the RDS file
```

And this is what the new loaded dataset looks like:
```{r}
knitr::kable(head(data_harvest))
data_harvest$quality = as.numeric(data_harvest$quality)
